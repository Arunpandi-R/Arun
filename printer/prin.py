...
def selet():
    ...
    btn1 = Button(root, text="OK", width=12, bg="light gray", command=root.quit)
    btn1.place(x=320, y=390)
    btn1 = Button(root, text="Cancel", width=12, bg="light gray", command=root.quit)
    btn1.place(x=430, y=390)


def Prsetting():
    s = showinfo("Printer setting", "Adjustment the page setup ")
